...
/home/biqu/klipper/scripts/calibrate_shaper.py $NEWY -o /home/biqu/printer_data/config/elements/input_shaping/input_shaper_results/shaper_calibrate_y_$DATE.png